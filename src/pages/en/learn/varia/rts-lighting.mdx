...
Make sure you are familiar with PlanarAlly's [lighting & vision system](/en/docs/dm/lighting-vision/), as well as its [layers](/en/docs/dm/layers) and the tokens' [auras](/en/docs/game/shapes/#trackers--auras) and [access](/en/docs/game/shapes/#access).
