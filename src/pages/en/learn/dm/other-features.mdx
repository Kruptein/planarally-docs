...
_full reference: [the initiative docs](/en/docs/tools/initiative/)_
...
_full reference: [the location docs](/en/docs/dm/locations/)_
...
_full reference: [the floor docs](/en/docs/dm/floors/)_
...
_full reference: [the asset docs](/en/docs/dashboard/assets/)_
