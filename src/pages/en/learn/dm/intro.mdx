...
You should probably have a read through the [player guide](/en/learn/player/intro/) which is quite short as we won't reiterate some of the basic things explained there (e.g. moving the camera etc).
...
For more info on this choice, see the [server documentation](/en/server/setup/).
...
This is something we're obviously going to fix, and we'll do that in [the next chapter](/en/learn/dm/first-map/).
