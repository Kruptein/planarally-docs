...
<Tip title="Tips">
    ...
    3. Even if the end result isn't perfect, you should be able to resize the map to a more accurate match way more easy
    now that the general size is roughly ok
</Tip>
...
[Next up](/en/learn/dm/other-features) we're going to check out some other features that you'll probably want to be aware of as a DM.
