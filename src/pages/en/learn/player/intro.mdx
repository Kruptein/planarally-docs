...
<Info title="PA servers">
    ...
    have to read up on the [server documentation](/en/server/setup/) and settle on a common server.
</Info>
...
<Warning title="It's all black?!">
    ...
    If they've done that and you still don't see anything, try hitting <kbd>space</kbd> to recenter the screen on a token you have vision access to.
...
This quick intro only got our feet wet, let's dive in completely and see what these tools are about and how we can interact with our character [in the next chapter](/en/learn/player/interaction/)!
