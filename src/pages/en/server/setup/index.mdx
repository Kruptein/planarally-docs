...
PlanarAlly does not have to be installed by each player, so if you're a player you can go straight ahead to getting started with PlanarAlly or the full docs over [here](/en/docs/).
...
If you already know what you would like to use, you can visit [External services](/en/server/setup/managed/) or [Self-Hosting](/en/server/setup/self-hosting), otherwise continue on reading to get some more info about both options!
