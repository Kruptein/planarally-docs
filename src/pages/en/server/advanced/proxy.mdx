...
Either your proxy setup is faulty, or you have cors issues. For the latter double check that the [cors config setting](/en/server/management/configuration/#field-cors_allowed_origins) is configured correctly
