...
The spell tool can be accessed in the toolbar on the bottom right of the screen by all players, but only in [Play mode](/en/docs/tools-overview/#toolbar-and-modes).
