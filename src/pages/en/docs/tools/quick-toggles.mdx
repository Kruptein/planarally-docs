...
When this is enabled the DM's screen will be rendered as if they are in fake player mode (See [Fake Player](/en/docs/dm/settings/#fake-player))

## Line of Sight

This quick toggle only shows up if you have [Line of Sight](/en/docs/dm/settings/#only-los) enabled.
...
When enabled it will turn green (until clicked again) and indicates that [initiative](/en/docs/tools/initiative/) is active.

It will automatically open the initiative UI for all players and will activate some of the [Initiative settings](/en/docs/game/settings/#initiative).
