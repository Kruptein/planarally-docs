...
It can be accessed in the toolbar on the bottom right of the screen by all players, but behaves differently, depending on the active [mode](/en/docs/tools-overview/#toolbar-and-modes).
...
This ruler works like the [independent ruler tool](/en/docs/tools/ruler/) and will also share its settings.
...
Rotating also has [snapping behaviour](/en/docs/game/snapping/) to common angles (multiples of 45 degrees).
