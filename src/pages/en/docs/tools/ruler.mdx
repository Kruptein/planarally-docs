...
The Ruler tool can be accessed in the toolbar at the bottom right of the Game Board, regardless of [mode](/en/docs/tools-overview/#toolbar-and-modes).
...
This setting will also be used by the ruler built into the [select tool](/en/docs/tools/select/).

The colour in which this is drawn can be chosen by each player in their [client settings](/en/docs/game/settings/).
The ruler also has [snapping behaviour](/en/docs/game/snapping/) that will try to snap to logical places on the grid.
