...
<Info title="Logo upload">The logo has to be uploaded as an [asset](/en/docs/dm/assets/).</Info>

## Join

To join a game you need the invite URL. This is something that the DM can create in-game through the DM-settings.
