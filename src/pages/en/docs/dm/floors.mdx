...
A complete set of stacked [layers](/en/docs/dm/layers/) is called a _floor_.
...
**Handy**: Make sure to look at the [movement keybindings](/en/docs/reference/#movement) to make navigating floors a breeze!

At any [location](/en/docs/dm/locations), there is always at least one floor present, thus, upon creation of the location, the first floor will be created, automatically.
