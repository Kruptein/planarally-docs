...
If you want to disable it permanently you can invert the behaviour in the [client settings](/en/docs/game/settings/), which will make the `alt` key act as a modifier to enable snapping instead.
