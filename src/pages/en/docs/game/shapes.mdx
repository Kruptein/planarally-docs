...
_To bring assets on the map you need to be a DM, see the [DM asset docs](/en/docs/dm/assets/)._

## Manipulating Objects

Selecting/interacting with objects is primarily done through the [select tool](/en/docs/tools/select/).
...
For more information, check the [floors](/en/docs/dm/floors/), [layers](/en/docs/dm/layers/) or [locations](/en/docs/dm/locations/) documents.
...
For more information, check the [initiative](/en/docs/tools/initiative/) document.
...
See [markers](/en/docs/game/markers/) for more information.
...
For more information see [Asset Templates](/en/docs/dm/assets/#templates)
...
This name will show up in some other places like the quick selection info and the [initiative](/en/docs/tools/initiative/) list.
...
More information about lighting can be found in the [lighting and vision](/en/docs/dm/lighting-vision/) document.
