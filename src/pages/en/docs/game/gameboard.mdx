...
See the [DM documentation on locations](/en/docs/dm/locations/) for more information.
...
For more in-depth explanation of the different layers, check the [DM docs](/en/docs/dm/layers/)!
...
Note that you might not be able to see everything on a different floor, depending on the [lighting](/en/docs/dm/lighting-vision) and whether you have sufficient access to the tokens on this floor.
