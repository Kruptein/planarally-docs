...
For more info on layers check the [layer documentation](/en/docs/dm/layers/).
...
| Alt (hold)       |         | Disable [snapping behaviour](/en/docs/game/snapping) |
| Ctrl + u         |         | Toggle UI                                            |
| Ctrl + z         |         | Undo                                                 |
| Ctrl + shift + z |         | Redo                                                 |
| n                |         | Open the [Note Manager](/en/docs/game/notes)         |
| Space            | ruler   | Set [ruler](/en/docs/tools/ruler) waypoints          |
...
| Space          | selection | Set [ruler](/en/docs/tools/ruler) waypoints       |
