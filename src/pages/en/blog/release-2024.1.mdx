...
For a full overview of the new note system, check the [notes documentation](/en/docs/game/notes/).
...
Combined with the use of [Asset Templates](/en/docs/dm/assets/#templates) you can drop a goblin on the board and have it automatically have the stat block attached.
