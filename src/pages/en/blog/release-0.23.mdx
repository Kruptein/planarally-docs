...
For more info on how which endpoints are available check the [API docs](/en/docs/server/api/).

## Quality of Life

### ruler snapping

The ruler now also has [snapping behaviour](/en/docs/game/snapping/) and will try to snap to one of 9 points for a certain grid cell.
