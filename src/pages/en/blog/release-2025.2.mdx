...
_Further reading: [Mail config section](/en/server/management/configuration/#mail)_
...
_Further reading: [Quick Toggles](/en/docs/tools/quick-toggles/)_
...
_Further reading: [Shape Access](/en/docs/game/shapes/#access)_
...
The server docs have been updated to show all [configuration options](/en/server/management/configuration/).
