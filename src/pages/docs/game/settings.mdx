...
<Image src={ClientSettingsPicture} width={600} aspectRatio={613 / 388} alt="Apparance Settings" />
...
<Image src={ClientSettingsBehaviourPicture} width={600} aspectRatio={612 / 291} alt="Behaviour Settings" />
