...
It will instead render using the vision of all the players you've selected in [the vision tool](/docs/tools/vision/).
This can help to verify during prep or even in-game that your vision setup is correct.

You can quickly toggle this on/off using [Quick Toggles](/docs/tools/quick-toggles/#fake-player)
...
The **Mod** tab lets you upload `.pam` mod packages for this campaign.
See the [mods documentation](/docs/dm/mods/) for what mods are and how they work.
