...
The Ruler tool can be accessed in the toolbar at the bottom right of the Game Board, regardless of [mode](/docs/tools-overview/#toolbar-and-modes).
...
The colour in which this is drawn can be chosen by each player in their [client settings](/docs/game/settings/).
The ruler also has [snapping behaviour](/docs/game/snapping/) that will try to snap to logical places on the grid.
