...
<Image src={ServerLandingPicture} alt="Gameboard PA server landing page" width="800px" aspectRatio="1:1" />
...
<Image src={DashboardPicture} alt="Gameboard PA dashboard page" width="800px" aspectRatio="1:1" />
...
<Image src={GridSettingsPicture} alt="Gameboard Grid Settings" width="800px" aspectRatio={1029 / 1137} />
...
<Image src={GridIdsPicture} alt="Gameboard Grid Ids" width="800px" aspectRatio={4032 / 2268} />
