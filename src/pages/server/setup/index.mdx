...
If you already know what you would like to use, you can visit [External services](/server/setup/managed/) or [Self-Hosting](/server/setup/self-hosting), otherwise continue on reading to get some more info about both options!
