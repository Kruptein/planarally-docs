...
In release [2024.1](/blog/release-2024.1) a big rework of the note system was introduced.
...
In [2024.2](/blog/release-2024.2#shape-grid-size) more control over a shape's size in the grid's context was added.
...
See [the config docs](/server/management/configuration/#logging) for more details.
