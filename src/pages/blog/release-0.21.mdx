...
<Image src="/blog/release-0.21/language.png" width={300} aspectRatio={360 / 334} alt="Language selection" />
...
<Image src="/blog/release-0.21/changelog.png" width={800} aspectRatio={1191 / 976} alt="Showing changelog" />
