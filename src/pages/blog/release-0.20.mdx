...
<Image src="/blog/release-0.20/rename-location.png" width={500} aspectRatio={580 / 248} alt="Rename Location" />
...
<Image src="/blog/release-0.20/access.png" width={500} aspectRatio={454 / 353} alt="Access Settings" />
